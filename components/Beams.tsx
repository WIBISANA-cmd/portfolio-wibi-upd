...
const CanvasWrapper: FC<{ children: ReactNode; isActive: boolean }> = ({ children, isActive }) => (
  <Canvas dpr={[1, 2]} frameloop={isActive ? "always" : "demand"} className="w-full h-full relative">
    {children}
  </Canvas>
);
...
const Beams: FC<BeamsProps> = ({
  ...
  return (
    <CanvasWrapper isActive={isActive}>
