        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <a 
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-white text-black rounded-full text-lg font-bold hover:scale-105 transition-transform"
            >
            ...
            <div className="flex items-center gap-4">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-4 glass rounded-full hover:bg-white/20 transition-colors text-white/70 hover:text-white hover-trigger space-x-2">
              ...
              <a href="https://github.com" target="_blank" rel="noreferrer" className="p-4 glass rounded-full hover:bg-white/20 transition-colors text-white/70 hover:text-white hover-trigger space-x-2">
